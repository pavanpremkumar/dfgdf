...
public class LeaveDetails {
  ...
  private SslAppliedStatus levSslAppliedStatus;
  ...
  public final boolean equals(final Object obj) {
    ...
    if (Objects.equals(levId, lev.levId)
        ...
        && Objects.equals(levSslAppliedStatus,lev.levSslAppliedStatus)
  ...
  public final int hashCode() {
    return Objects.hash(levId, levNoOfDays, levStartDate, levEndDate, levType,levSslAppliedStatus,
  ...
  public final String toString() {
    ...
    return " LevId:" + levId + " Leave No. of days:" + levNoOfDays
             ...
             + " Leave Type:" + levType + "Sslappliedstatus:" + levSslAppliedStatus
  ...
  */
  ...
  public LeaveDetails(final int argLevId, final int argLevNoOfDays, final Date argLevStartDate,
                     ...
                     final SslAppliedStatus argLevSslAppliedStatus,
    ...
    this.levSslAppliedStatus = argLevSslAppliedStatus;
   ...
   */
  public final SslAppliedStatus getLevSslAppliedStatus() {
    return levSslAppliedStatus;
  }
   ...
   */
  public final void setLevSslAppliedStatus(final SslAppliedStatus argLevSslAppliedStatus) {
    this.levSslAppliedStatus = argLevSslAppliedStatus;
  }
  ...
  public static String applyLeave(final int argEmpId,
    ...
    // System.out.println("Office days:" + officehol);
    Date cur = new Date();
    ...
    Calendar ofCal = Calendar.getInstance();
    days = days + 1;
    // System.out.println("New days1:" + days);
    // System.out.println("After weekend days1:" + days);
          ...
          if(choice.equals("YES")) {
            if (argLevNoOfDays <= 30) {
                ...
                dao().insert(argEmpId, argLevStartDate, argLevEndDate,.
                 argLevNoOfDays,
                argLevType, leaStatus, argLevReason, leaAppliedOn);
